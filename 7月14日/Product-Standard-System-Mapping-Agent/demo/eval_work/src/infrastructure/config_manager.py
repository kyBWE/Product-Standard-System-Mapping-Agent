...
from src.models.config_models import DBConfig, EmbeddingConfig, ExpansionConfig, LLMConfig, MatchConfig, RerankConfig
...
class ConfigManager:
    ...
    def get_llm_config(self) -> LLMConfig:
        ...
        return LLMConfig(
            ...
            embedding_model=llm.get("embedding_model", "api"),
            embedding_dimension=llm.get("embedding_dimension", 1024),
    ...
    def get_embedding_config(self) -> EmbeddingConfig:
        ...
        return EmbeddingConfig(
            api_key=os.environ.get("EMBEDDING_API_KEY", emb.get("api_key", "")),
            base_url=emb.get("base_url", "https://api.modelarts-maas.com/v1/embeddings"),
    ...
    def get_expansion_config(self) -> ExpansionConfig:
        exp = self._config.get("expansion", {})
        return ExpansionConfig(
            syn_threshold=exp.get("syn_threshold", 5),
            auto_cluster=exp.get("auto_cluster", True),
        )
